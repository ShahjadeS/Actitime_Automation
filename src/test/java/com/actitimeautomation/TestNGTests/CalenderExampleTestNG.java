...
public class CalenderExampleTestNG extends BaseClass {
    WebDriver driver;
    ...
    @Test
    public void CalenderExampleTest() throws InterruptedException {
